...
// engine and the iOS unlock dance are lifted from five-in-a-row/src/core/
// audio.js (see the long comment there for why every part of the unlock
// exists); only the named effects at the bottom are this game's.
...
export function playDraw() { tone({ freq: 380, duration: 0.05, type: "triangle", gain: 0.07, slideTo: 300 }); }
/** A card turning face up. */
export function playFlip() { tone({ freq: 440, duration: 0.05, type: "sine", gain: 0.06, slideTo: 620 }); }

 ...
 * Worse, several of them overlapped, swapping the DOM stub and the
 * module singletons they each set up out from under one another. The
 * three async tests in test/page.test.js — the i18n key sweep and the
 * two that boot the page — were reported on without ever being waited
 * for, so "40 passed" was really 37 checked and 3 taken on trust.
 *

 ...
 * No suite in this game declares an async test today, which is the only
 * reason its number was ever honest. The fix lands here anyway: the
 * harness is copied between games, and the first async test anyone
 * writes in it would otherwise have printed ok without running.
 *

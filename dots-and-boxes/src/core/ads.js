...
//
//   requestRewardedHint() resolves "granted" at once. On the portal a hint
//   past the free allowance is paid for by watching a rewarded video; here
//   it is simply free, the same policy as the site's Mahjong (unlimited
//   hints) and Five in a Row. main.js is unchanged: it still asks, and the
...
/** No interstitials on this site. The portal build showed one every other
 * game over; here the game-over banner is the whole of it. */

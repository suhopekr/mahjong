 ...
 * The one async test in test/page.test.js — the i18n key sweep, which
 * dynamic-imports every strings file — was reported on without ever
 * being waited for, so "40 passed" was really 39 checked and 1 taken on
 * trust.
 *
